...
{
    /// <inheritdoc />
    public partial class yuyuytrt : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MusoniClientID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    MusoniClientStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MusoniLoanID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MusoniClientID = table.Column<int>(type: "int", nullable: false),
                    ...
                    NumberOfRepayments = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InterestRatePerPeriod = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    expectedDisbursementDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MusoniLoanStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateCreated = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FileName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BatchID = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
